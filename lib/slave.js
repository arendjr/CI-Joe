 ...
 * Slave.
 *
 * Maintains settings of a single slave.
 *
...
_.extend(Slave.prototype, {
    ...
    setType: function(type) {
        ...
        if (this.type !== type) {
            if (type === "local" || type === "remote") {
                ...
                throw new Error("Invalid slave type: " + type);
            }
        }
    },
    ...
    _connectToMaster: function() {
        ...
        console.log("STUB: Slave._connectToMaster()");
    },
    ...
    _startLocalSlave: function() {
        ...
        var self = this;
        var child = childProcess.spawn("node", ["app/slave.js"], { cwd: process.cwd() });
